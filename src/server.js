...
io.on('connection', socket => {
  ...
  socket.on('chatMessage', payload => {
    ...
    if (from === 'agent') {
      // Mensaje desde CRM → a widgets (NOTA: excluimos el socket emisor)
    ...
    // IMPORTANTE: antes era io.to(sessionId)
    // Esto reenviaba TAMBIÉN al mismo socket que lo mandó → duplicados en el CRM.
    // Con socket.to(sessionId) excluimos al emisor.
